        ...
        items: [
            {
                ...
                a: "<p>Gravity Field Dynamics (GFD) is a covariant, parameter-free theory of gravity. It is expressed through dual-tetrad gravity (DTG): two coupled tetrahedral field chambers forming a stellated octahedron, with a coupling hierarchy governed by the simplex number k = 4. The topology uniquely determines the scalar Lagrangian, the acceleration scale, and the complete gravitational action, with no free parameters.</p><div class='faq-advanced'><div class='faq-advanced-label'>The GFD action</div><p>The full scalar-tensor action is:</p><span class='faq-eq'>S = &int; d<sup>4</sup>x &radic;(&minus;g) [ R/16&pi;G &minus; (a<sub>0</sub><sup>2</sup>/8&pi;G) F(|&nabla;&Phi;|<sup>2</sup>/a<sub>0</sub><sup>2</sup>) &minus; &frac14; e<sup>&minus;2&Phi;/c<sup>2</sup></sup> F<sub>&mu;&nu;</sub>F<sup>&mu;&nu;</sup> + L<sub>matter</sub> ]</span><p>where the scalar Lagrangian density F(y) is uniquely determined by the coupling polynomial f(k) = 1 + k + k<sup>2</sup>:</p><span class='faq-eq'>F(y) = y/2 &minus; &radic;y + ln(1 + &radic;y)</span><span class='faq-eq-label'>y = |&nabla;&Phi;|<sup>2</sup> / a<sub>0</sub><sup>2</sup></span><p>The three terms of F(y) correspond directly to the three structural levels of the stellated octahedron: the quadratic term (k<sup>2</sup> = 16 coupled face channels), the square-root term (k = 4 face couplings), and the logarithmic term (k<sup>0</sup> = 1, the Field Origin). GRAVIS evaluates the field equation that follows from this Lagrangian.</p></div>"
            },
            {

        ...
        items: [
            {
                ...
                a: "<p>Gravity Field Dynamics is the covariant completion of dual tetrad gravity. It describes the gravitational field as two coupled tetrahedral field chambers that form a stellated octahedron, with a coupling hierarchy governed by the simplex number k = 4. The topology uniquely determines the scalar Lagrangian, the acceleration scale, and the complete gravitational action, with no free parameters.</p><div class='faq-advanced'><div class='faq-advanced-label'>The covariant action</div><p>The full scalar-tensor action is:</p><span class='faq-eq'>S = &int; d<sup>4</sup>x &radic;(&minus;g) [ R/16&pi;G &minus; (a<sub>0</sub><sup>2</sup>/8&pi;G) F(|&nabla;&Phi;|<sup>2</sup>/a<sub>0</sub><sup>2</sup>) &minus; &frac14; e<sup>&minus;2&Phi;/c<sup>2</sup></sup> F<sub>&mu;&nu;</sub>F<sup>&mu;&nu;</sup> + L<sub>matter</sub> ]</span><p>where the scalar Lagrangian density F(y) is uniquely determined by the coupling polynomial f(k) = 1 + k + k<sup>2</sup>:</p><span class='faq-eq'>F(y) = y/2 &minus; &radic;y + ln(1 + &radic;y)</span><span class='faq-eq-label'>y = |&nabla;&Phi;|<sup>2</sup> / a<sub>0</sub><sup>2</sup></span><p>The three terms of F(y) correspond directly to the three structural levels of the stellated octahedron: the quadratic term (k<sup>2</sup> = 16 bimetric channels), the square-root term (k = 4 face couplings), and the logarithmic term (k<sup>0</sup> = 1, the Field Origin). GRAVIS evaluates the field equation that follows from this Lagrangian.</p></div>"
            },
            {
                q: "What is the acceleration scale a0?",
                a: "<p>The acceleration scale is the characteristic threshold below which the gravitational field cannot sustain full coupling across all k<sup>2</sup> = 16 bimetric channels. It is derived from the topology:</p><span class='faq-eq'>a<sub>0</sub> = k<sup>2</sup> G m<sub>e</sub> / r<sub>e</sub><sup>2</sup> &asymp; 1.22 &times; 10<sup>&minus;10</sup> m/s<sup>2</sup></span><p>where m<sub>e</sub> is the electron mass and r<sub>e</sub> is the classical electron radius. Above a<sub>0</sub>, gravity is Newtonian. Below it, the field enters partial coupling and the effective gravitational response is enhanced.</p><div class='faq-advanced'><div class='faq-advanced-label'>Computing a<sub>0</sub> from constants</div><p>With k = 4 (the simplex number in d = 3 spatial dimensions):</p><p>a<sub>0</sub> = 16 &times; (6.674 &times; 10<sup>&minus;11</sup>) &times; (9.109 &times; 10<sup>&minus;31</sup>) / (2.818 &times; 10<sup>&minus;15</sup>)<sup>2</sup></p><p>= 16 &times; 6.674 &times; 9.109 / 7.940 &times; 10<sup>&minus;11&minus;31+30</sup></p><p>= <strong>1.224 &times; 10<sup>&minus;10</sup> m/s<sup>2</sup></strong></p><p>This uses only CODATA 2022 fundamental constants and the integer k = 4. No fitting. The result matches the empirically determined MOND acceleration scale to within a few percent.</p></div>"
            },
            {
            ...
            },
            {
                ...
                a: "<p>The coupling polynomial <strong>f(k) = 1 + k + k<sup>2</sup></strong> encodes the three structural levels of the stellated octahedron:</p><ul><li><strong>k<sup>0</sup> = 1</strong>: The Field Origin (single interaction vertex)</li><li><strong>k<sup>1</sup> = 4</strong>: Face coupling channels through the vierbein</li><li><strong>k<sup>2</sup> = 16</strong>: Full bimetric interaction (4 faces &times; 4 faces)</li></ul><p>These three levels determine the complete coupling architecture of the gravitational field and map directly onto the three terms of the Lagrangian density F(y) = y/2 &minus; &radic;y + ln(1 + &radic;y).</p>"
            },
            {
